...
COD_STATUS_PENDING = 'COD_PENDING'
...
COD_PENDING_CODE = 'yg_cod_01'
COD_COLLECTED_CODE = 'yg_cod_02'
COD_TRANSFERRED_TO_TL_CODE = 'yg_cod_03'
COD_BANK_DEPOSITED_CODE = 'yg_cod_04'
COD_VERIFIED_CODE = 'yg_cod_05'
COD_TRANSFERRED_TO_CLIENT_CODE = 'yg_cod_06'
COD_CLOSED_CODE = 'yg_cod_07'

# TRANSACTION_TYPE
TRANSFER_TO_TL = 'TRANSFER_TO_TL'
