/*! Vendor-Webaap - v0.0.0 - 2016-03-10 */
!function() {
    "use strict";
	...
	*/
    ...
    var a = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
		...
		*/
        ...
        this.searchOrderActive = void 0 !== this.params.search, /*
    ...
    var a = function(a, b, c, d, e, f, g) {
        var h = this;
        h.order = c.payload.data, /*
			function to redirect back to the previous page or parent page.
		*/
        h.goBack = function() {
            g.isAvailable() ? g.redirectToPrevious() : a.go("home.opsorder");
        };
    };
    angular.module("order").controller("orderDetailCntrl", [ "$state", "$stateParams", "order", "DeliveryGuy", "orderDgAssign", "OrderStatusUpdate", "PreviousState", a ]);
}(), function() {
    "use strict";
