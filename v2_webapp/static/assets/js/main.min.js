/*! Vendor-Webaap - v0.0.0 - 2016-02-23 */
!function() {
    "use strict";
    var a = function(a, b, c, d) {
        this.loader = !1, this.userLogin = function() {
            ...
            b.login(f).then(function(b) {
                c.token = b.data.auth_token, d.$refresh().then(function(b) {
                    b.$updateuserRole(), a.go("home");
                });
            }, function(a) {
                e.loader = !1, e.error_message = a.data.non_field_errors[0];
            });
        };
    };
    ...
    } ]).controller("LoginCntrl", [ "$state", "AuthService", "$localStorage", "vendorClients", a ]);
}(), function() {
    "use strice";
    var a = function(a, b) {
        return {
            login: function(c) {
                return a.post(b.v1baseUrl + "auth/login/", c);
            }
        };
    };
    ...
    var a = function(a, b, c, d, e) {
        ...
        var g = c.confirm().parent(angular.element(document.querySelector("#body"))).clickOutsideToClose(!1).title("Are you sure you want to Sign Out?").textContent("After this you will be redirected to login page.").ariaLabel("Sign Out").targetEvent().ok("Sign Out!").cancel("Not Now").openFrom("#logout-button").closeTo("#logout-button");
        this.toggleSideNav = function() {
            b("left").toggle();
        }, this.logout = function() {
            e.$clearUserRole(), e.$refresh().then(function(b) {
                a.go("login");
            });
        }, this.showLogoutDialog = function() {
            c.show(g).then(function() {
                f.logout();
            });
        };
    };
    ...
    } ]).controller("homeCntrl", [ "$state", "$mdSidenav", "$mdDialog", "constants", "vendorClients", a ]);
}(), function() {
    "use strict";
    ...
    angular.module("ygVendorApp").constant("constants", d);
}(), function() {
    "use strict";
    var a = function(a, b) {
        var c = {
    ...
    angular.module("ygVendorApp").factory("Access", [ "$q", "vendorClients", a ]);
}(), function() {
    "use strict";
    var a = function(a, b) {
        return {
    ...
    var a = function(a, b) {
        return {
            getOrders: a(b.v2baseUrl + "order/:id/", {
                id: "@id"
            }, {
                query: {
                    method: "GET",
    ...
    "use strict";
    var a = function(a, b) {
        return a(b.v1baseUrl + "vendor/:id", {
            id: "@id"
        }, {
            profile: {
                method: "GET"
            ...
            query: {
                ...
                transformResponse: function(a) {
                    ...
                    if (angular.isArray(b)) {
                        var c = {};
                        return c.store_name = "Operations", c.vendors = b, c;
                    }
                    return b;
                }
            }
...
function() {
    ...
    var a = function(a, b, c) {
        var d = {
            responseError: function(d) {
                var e = a.defer();
                return (401 === d.status || 403 === d.status) && (b.$reset(), c.path("/login")), 
                e.reject(d), e.promise;
            }
        };
        return d;
    }, b = function(a, b, c, d) {
    ...
    angular.module("ygVendorApp").factory("errorHandler", [ "$q", "$localStorage", "$location", a ]).config([ "$httpProvider", function(a) {
	...
	*/
    var a = function(a, b) {
        return {
            isAvailable: function() {
                return a.previousState.state && "" !== a.previousState.state ? !0 : !1;
            },
    ...
    var a = function(a, b) {
        var c = {
            ...
            $setUserRole: function() {
                if (b.token) {
                    var c = a.decode(b.token).split(":");
                    userrole = c[1], authenticated = !0;
                } else userrole = "anonymous", authenticated = !1;
            },
    ...
    var a = function(a, b, c) {
        var d = {}, e = function() {
            var f = a.defer();
            return c.query(function(a) {
                f.resolve(angular.extend(d, a, {
                    $refresh: e,
                    $updateuserRole: function() {
                        return b.$setUserRole();
                    },
                    $clearUserRole: function() {
                        return b.$resetUserRole();
                    },
                    $hasRole: function(a) {
                        return b.$getUserRole().userrole == a;
                    },
                    $isAuthenticated: function() {
                        return b.$getUserRole().is_authenticated;
                    },
                    $isAnonymous: function() {
                        return !b.$getUserRole().is_authenticated;
                    }
    ...
    angular.module("ygVendorApp").factory("vendorClients", [ "$q", "role", "Vendor", a ]);
}(), function() {
    "use strict";
    ...
    var a = function(a, b, c, d, e, f, g, h) {
		...
		*/
        var i = this;
        this.params = c, this.statusArray = void 0 === c.dg ? [] : c.dg.split(","), this.params.date = new Date(this.params.date), 
        this.vendor_list = d.vendors, /*
			 scope Orders variable assignments are done from this section for the controller
		*/
        this.orders = f.data, this.orderFrom = 50 * (this.params.page - 1) + 1, this.orderTo = this.orderFrom - 1 + f.data.length, 
        this.total_pages = f.total_pages, this.total_orders = f.total_orders, this.pending_orders_count = f.pending_orders_count, 
        this.unassigned_orders_count = f.unassigned_orders_count, /*
		...
		*/
        this.paginate = {
            nextpage: function() {
                i.params.page = i.params.page + 1, i.getOrders();
            },
		...
		*/
        this.dgSearchTextChange = function(a) {
            ...
            return e.dgPageQuery.query(b).$promise.then(function(a) {
                return a.data;
            });
        }, this.selectedDgChange = function(a) {
            a ? i.params.dg = a.phone_number : i.params.dg = void 0, i.getOrders();
        }, /*
			@getOrders rleoads the order controller according too the filter to get the new filtered data.
		*/
        this.handleOrdeSelection = {
            selectActive: h.isSelected(),
            numberOfSelectedOrder: h.slectedItemLength(),
            update: function() {
                i.handleOrdeSelection.selectActive = h.isSelected(), i.handleOrdeSelection.numberOfSelectedOrder = h.slectedItemLength();
            },
            toggle: function(a) {
                h.toggle(a), i.handleOrdeSelection.update();
            },
            exists: function(a) {
                return h.exists(a);
            },
            clear: function() {
                h.clearAll(), i.handleOrdeSelection.update();
            }
        }, /*
			@getOrders rleoads the order controller according too the filter to get the new filtered data.
		*/
        this.getOrders = function() {
            a.transitionTo(a.current, i.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
    ...
    } ]).controller("opsOrderCntrl", [ "$state", "$mdSidenav", "$stateParams", "vendorClients", "DeliveryGuy", "orders", "constants", "orderSelection", a ]).controller("vendorOrderCntrl", [ "$state", b ]);
}(), function() {
    "use strict";
    var a = function() {
        return a;
    ...
    var a = function() {
        var a = {
            ...
            isSelected: function() {
                return a.selectedItemArray.length > 0 ? !0 : !1;
            },
            clearAll: function() {
	...
	*/
    var a = function(a, b, c, d, e) {
        ...
        this.searchDgActive = void 0 !== this.params.search ? !0 : !1, /*
		...
		*/
        this.backFromSearch = function() {
            f.params.search = void 0, f.searchDgActive = !1, f.getDgs();
        }, /*
			@getOrders rleoads the order controller according too the filter to get the new filtered data.
		*/
    ...
    angular.module("deliveryguy").controller("dgListCntrl", [ "$state", "$mdSidenav", "$stateParams", "dgs", "constants", a ]);
}(), function() {
    "use strict";
    /*
	...
	*/
    ...
    function a(a, b, c, d, e) {
        var f = this;
        f.DG = c, f.DG.team_lead_ids = [], f.DG.ops_manager_ids = [], f.DG.team_leads.forEach(function(a) {
            a.dg_id && f.DG.team_lead_ids.push(a.dg_id);
        }), f.DG.ops_managers.forEach(function(a) {
            f.DG.ops_manager_ids.push(a.employee_id);
        }), f.OpsManagers = d, f.TeamLeads = e, console.log(f.DG), f.shift_timings = b.shift_timings, 
        f.transportation_mode = b.transportation_mode, f.cancel = function() {
            a.cancel();
        }, f.answer = function(b) {
            a.hide(b);
        };
    ...
    var b = function(b, c, d, e, f, g, h, i) {
        console.log(h);
        var j = this;
        j.DG = h.payload.data.data, j.attendance_date = moment().date(1).toDate(), console.log(j.attendance_date), 
        j.attendanceMinDate = moment("2015-01-01").toDate(), j.attendanceMaxDate = moment().toDate(), 
        j.OpsManagers = g.OpsManager.payload.data, j.TeamLeads = g.TeamLead.payload.data, 
        j.showEditDialog = function() {
            var b = d("sm") || d("xs");
            c.show({
                ...
                locals: {
                    DG: j.DG,
                    OpsManagers: j.OpsManagers,
                    TeamLeads: j.TeamLeads
                }
            }).then(function(a) {
                e.dg.$update(a, function(a) {
                    console.log(a);
                });
            }, function() {
                j.status = "You cancelled the dialog.";
            });
        }, /*
			function to redirect back to the previous page or parent page.
		*/
        j.goBack = function() {
            i.isAvailable() ? i.redirectToPrevious() : b.go("home.dgList");
        }, j.onlyMonthsPredicate = function(a) {
            var b = moment(a).date();
            return 1 === b;
        }, j.getAttendance = function() {
            var a = {
                id: j.DG.id,
                month: moment(j.attendance_date).month(),
                year: moment(j.attendance_date).year()
            };
            e.dg.attendance(a, function(a) {
                j.dg_monthly_attendance = a.payload.data.dg_monthly_attendance[0].attendance, console.log(a);
            });
        };
    };
    angular.module("deliveryguy").controller("dgDetailCntrl", [ "$state", "$mdDialog", "$mdMedia", "DeliveryGuy", "dgConstants", "leadUserList", "DG", "PreviousState", b ]);
}();
