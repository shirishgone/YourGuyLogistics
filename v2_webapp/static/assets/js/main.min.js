/*! Vendor-Webaap - v0.0.0 - 2016-03-16 */
!function() {
    "use strict";
    ...
    "use strict";
    angular.module("ygVendorApp", [ "ngMaterial", "ngMessages", "ui.router", "ngStorage", "ngResource", "base64", "login", "home", "order", "deliveryguy", "vendor", "reports", "Cod", "forbidden" ]).config([ "$urlRouterProvider", "$locationProvider", "$resourceProvider", "$mdThemingProvider", "roleProvider", function(a, b, c, d, e) {
    ...
    angular.module("Cod", []).config([ "$stateProvider", function(a) {
        a.state("home.cod", {
            ...
            resolve: {
                access: [ "Access", "constants", function(a, b) {
                    var c = [ b.userRole.OPS, b.userRole.OPS_MANAGER, b.userRole.ACCOUNTS ];
                    return a.hasAnyRole(c);
                } ]
            }
        });
