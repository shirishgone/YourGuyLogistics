/*! Vendor-Webaap - v0.0.0 - 2016-04-14 */
!function() {
    "use strict";
    ...
    var a = function(a, b, c, d, e, f, g) {
        var h = this;
        this.params = c, console.log(this.params), this.params.start_date = new Date(this.params.start_date), 
        this.params.end_date = new Date(this.params.end_date), this.dg_status = e.dg_status, 
        this.searchDgActive = void 0 !== this.params.search, this.dgs = d.payload.data.data, 
        this.total_pages = d.payload.data.total_pages, this.total_dgs = d.payload.data.total_count, 
        this.toggleFilter = function() {
    ...
    function a(a, b, c, d, e, f) {
        var g = this;
        g.DG = angular.copy(c), console.log(g.DG), g.DG.team_lead_dg_ids = [], g.DG.ops_manager_ids = [], 
        g.DG.team_leads.forEach(function(a) {
    ...
    var e = function(e, f, g, h, i, j, k, l, m, n, o) {
        var p = this;
        p.params = f, p.DG = m.payload.data, p.attendance_date = moment().date(1).toDate(), 
        p.attendanceMinDate = moment("2015-01-01").toDate(), p.attendanceMaxDate = moment().toDate(), 
        p.OpsManagers = l.OpsManager.payload.data, p.TeamLeads = l.TeamLead.payload.data, 
        p.showEditDialog = function() {
            var b = h("sm") || h("xs");
            g.show({
                ...
                locals: {
                    DG: p.DG,
                    OpsManagers: p.OpsManagers,
                    TeamLeads: p.TeamLeads
                }
            }).then(function(a) {
                o.loaderStart(), a.shift_time = angular.fromJson(a.shift_time), i.dg.$update(a, function(a) {
                    p.getDgDetails(), o.loaderComplete();
                });
            }, function() {
                p.status = "You cancelled the dialog.";
            });
        }, p.goBack = function() {
            n.isAvailable() ? n.redirectToPrevious() : e.go("home.dgList");
        }, p.deactivateDgDialog = function() {
            var a = h("sm") || h("xs");
            g.show({
                ...
                o.loaderStart(), i.dg.deactivate(a, function(a) {
                    o.loaderComplete(), o.showSuccess("DG deactivated successfully"), p.getDgDetails();
                });
            });
        }, p.onlyMonthsPredicate = function(a) {
            var b = moment(a).date();
            return 1 === b;
        }, p.getTeamMembers = function() {
            i.dg.associated_dgs({
                id: p.DG.id
            }, function(a) {
                p.associated_dg_list = a.payload.data;
            });
        }, p.DG.is_teamlead && p.getTeamMembers(), p.toTeamlead = function() {
            g.show({
                ...
                locals: {
                    DG: p.DG,
                    teamMembers: p.associated_dg_list
                }
            }).then(function(a) {
                o.loaderStart(), p.DG.is_teamlead ? i.dg.$update(a, function(a) {
                    o.loaderComplete(), p.getDgDetails();
                }) : i.dg.promoteToTL(a, function(a) {
                    o.loaderComplete(), p.getDgDetails();
                });
            }, function() {
                p.status = "You cancelled the dialog.";
            });
        }, p.associateVendors = function() {
            g.show({
                ...
                o.loaderStart(), i.dg.associateVendors(a, function(a) {
                    o.loaderComplete(), p.getDgDetails();
                });
            });
        }, p.getAttendance = function() {
            var a = {
                id: p.DG.id,
                month: moment(p.attendance_date).month() + 1,
                year: moment(p.attendance_date).year()
            };
            i.dg.attendance(a, function(a) {
                p.dg_monthly_attendance = a.payload.data.attendance;
            });
        }, p.getDgDetails = function() {
            e.transitionTo(e.current, p.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
    ...
    angular.module("deliveryguy").controller("dgDetailCntrl", [ "$state", "$stateParams", "$mdDialog", "$mdMedia", "DeliveryGuy", "Vendor", "dgConstants", "leadUserList", "DG", "PreviousState", "Notification", e ]);
}(), function() {
    "use strict";
