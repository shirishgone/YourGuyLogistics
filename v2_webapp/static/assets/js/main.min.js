...
this.backFromSearch=function(){f.params.search=void 0,f.searchDgActive=!1,f.getDgs()},/*
			@getOrders rleoads the order controller according too the filter to get the new filtered data.
		*/
this.getDgs=function(){a.transitionTo(a.current,f.params,{reload:!0,inherit:!1,notify:!0})}};angular.module("deliveryguy").controller("dgListCntrl",["$state","$mdSidenav","$stateParams","dgs","constants",a])}(),function(){"use strict";/*
	...
	*/
var a=function(a,b,c,d,e,f){var g=this;/*
...
g.dg=new d.dg,/*
		...
		*/
g.goBack=function(){f.isAvailable?f.redirectToPrevious():$state.go("home.dgList")},/*
		...
		*/
g.create=function(){g.dg.shift_timing=angular.fromJson(g.dg.shift_timing),g.dg.$save(function(){g.goBack()})}};angular.module("deliveryguy").controller("dgCreateCntrl",["$mdSidenav","$stateParams","dgConstants","DeliveryGuy","leadUserList","PreviousState",a])}();
