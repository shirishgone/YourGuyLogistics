/*! Vendor-Webaap - v0.0.0 - 2016-03-05 */
!function() {
    "use strict";
...
function() {
	...
	*/
    ...
    var a = function(a, b, c, d, e, f, g, h) {
		...
		*/
        var i = this;
        this.params = c, this.statusArray = void 0 === c.dg ? [] : c.dg.split(","), this.pincodesArray = void 0 === c.pincodes ? [] : c.dg.split(","), 
        this.params.date = new Date(this.params.date), this.searchedDg = this.params.dg, 
        /*
			 scope Orders variable assignments are done from this section for the controller
		*/
        this.orders = e.payload.data.data, this.orderFrom = 50 * (this.params.page - 1) + 1, 
        this.orderTo = this.orderFrom - 1 + e.payload.data.data.length, this.total_pages = e.payload.data.total_pages, 
        this.total_orders = e.payload.data.total_orders, this.pending_orders_count = e.payload.data.pending_orders_count, 
        this.unassigned_orders_count = e.payload.data.unassigned_orders_count, this.pincodes = h.payload.data, 
        /*
		...
		*/
        this.dgSearchTextChange = function(a) {
            ...
            a ? i.params.dg = a.phone_number : i.params.dg = void 0;
        }, /*
		...
		*/
        this.handleOrdeSelection = {
            ...
            update: function() {
                i.handleOrdeSelection.selectActive = g.isSelected(), i.handleOrdeSelection.numberOfSelectedOrder = g.slectedItemLength();
            },
            toggle: function(a) {
                g.toggle(a), i.handleOrdeSelection.update();
            },
            exists: function(a) {
                return g.exists(a);
            },
            clear: function() {
                g.clearAll(), i.handleOrdeSelection.update();
            }
        }, /*
			@getOrders rleoads the order controller according too the filter to get the new filtered data.
		*/
    ...
    angular.module("order").controller("opsOrderCntrl", [ "$state", "$mdSidenav", "$stateParams", "DeliveryGuy", "orders", "constants", "orderSelection", "Pincodes", a ]);
}(), function() {
    "use strict";
