/*! Vendor-Webaap - v0.0.0 - 2016-04-02 */
!function() {
    "use strict";
    ...
    var a = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
        ...
        this.status_list = j.status, this.time_list = j.time, this.backFromSearch = function() {
            ...
            a ? q.params.dg_username = a.phone_number : q.params.dg_username = void 0;
            ...
            a ? q.params.vendor_id = a.id : q.params.vendor_id = void 0;
            ...
            o.openStatusDialog().then(function(a) {
                a.delivery_ids = k.getAllItemsIds(), a.isPickup ? q.updatePickupStatus(a) : q.updateDeliveryStatus(a);
            });
        ...
        a.state("home.reports", {
            ...
            resolve: {
                ...
                report: [ "Reports", "$stateParams", function(a, b) {
                    var c = new Date();
                    return c.setHours(0), c.setMinutes(0), c.setSeconds(0), b.start_date = void 0 !== b.start_date ? new Date(b.start_date).toISOString() : c.toISOString(), 
                    b.end_date = void 0 !== b.end_date ? new Date(b.end_date).toISOString() : new Date().toISOString(), 
