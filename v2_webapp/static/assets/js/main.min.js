/*! Vendor-Webaap - v0.0.0 - 2016-04-13 */
!function() {
    "use strict";
    ...
    var a = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
        ...
        this.revertToPageOne = function() {
            ...
            q.params.vendor_id || (q.params.vendor_name = void 0), q.params.dg_username && "UNASSIGNED_PICKUP" != q.params.dg_username && "UNASSIGNED_DELIVERY" != q.params.dg_username && "UNASSIGNED" != q.params.dg_username || (q.params.dg_name = void 0), 
    ...
    var a = function(a, b, c, d, e, f, g) {
        ...
        h.Pincodes = e.Pincodes.payload.data, h.dg = new d.dg(), h.goBack = function() {
            ...
            g.loaderStart(), h.dg.shift_timing = angular.fromJson(h.dg.shift_timing), console.log(h.dg), 
            h.dg.$save(function(a) {
                h.goBack();
            });
        };
    };
    ...
    var c = function(c, d, e, f, g, h, i, j) {
        ...
        k.total_deposits = f.payload.data.total_count, this.searchVendor = this.params.dg_name, 
