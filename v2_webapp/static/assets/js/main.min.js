/*! Vendor-Webaap - v0.0.0 - 2016-03-21 */
!function() {
    "use strict";
        ...
        this.loader = !1, this.userLogin = function() {
            ...
            b.login(g).then(function(b) {
                d.token = b.data.payload.data.auth_token, c.$refresh().then(function(b) {
                    b.role === e.userRole.OPS_MANAGER || b.role === e.userRole.OPS ? a.go("home.opsorder") : b.role === e.userRole.VENDOR ? a.go("home.order") : b.role === e.userRole.HR ? a.go("home.dgList") : b.role === e.userRole.ACCOUNTS && a.go("home.cod");
                });
            }, function(a) {
    ...
    function a(a, b) {
        ...
        c.total_cod_amount = 0, c.deposits = b, c.deposits.forEach(function(a) {
            c.total_cod_amount += a.deliveries[0].cod_amount;
        }), c.cancel = function() {
            a.cancel();
        }, c.answer = function(b) {
            a.hide(b);
        ...
        this.paginate = {
            ...
            toggle: function(a) {
                if (console.log(i.handleSelection.selectedItemArray.length), i.handleSelection.selectedItemArray.length > 0) {
                    if (a.deliveries[0].vendor_id != i.handleSelection.selectedVendor) return void alert("You cannot select different vendor");
                } else console.log("sds"), i.handleSelection.selectedVendor = a.deliveries[0].vendor_id;
            ...
            getAlltransactionIds: function() {
                ...
                return i.handleSelection.selectedItemArray.forEach(function(b) {
                    a.push(b.deliveries[0].delivery_id);
                }), a;
            }
