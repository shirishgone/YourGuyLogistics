/*! Vendor-Webaap - v0.0.0 - 2016-02-20 */
!function() {
    "use strict";
...
function() {
	...
	*/
    ...
    var b = function(b, c, d, e, f, g, h) {
        console.log(g);
        var i = this;
        i.OpsManagers = f.OpsManager.payload.data, i.TeamLeads = f.TeamLead.payload.data, 
        i.showEditDialog = function() {
            var b = d("sm") || d("xs");
            c.show({
                ...
                locals: {
                    DG: i.DG,
                    OpsManagers: i.OpsManagers,
                    TeamLeads: i.TeamLeads
                }
            }).then(function(a) {
                i.status = 'You said the information was "' + a + '".';
            }, function() {
                i.status = "You cancelled the dialog.";
            });
        }, /*
			function to redirect back to the previous page or parent page.
		*/
        i.goBack = function() {
            h.isAvailable() ? h.redirectToPrevious() : b.go("home.dgList");
        }, i.DG = g.payload.data.data;
    };
    angular.module("deliveryguy").controller("dgDetailCntrl", [ "$state", "$mdDialog", "$mdMedia", "dgConstants", "leadUserList", "DG", "PreviousState", b ]);
}();
