/*! Vendor-Webaap - v0.0.0 - 2016-02-25 */
!function() {
    "use strict";
    ...
    var a = function(a, b, c, d, e) {
        ...
        this.tabs = d.permissible_tabs[e.role];
    ...
    } ]).controller("homeCntrl", [ "$state", "$mdSidenav", "$mdDialog", "constants", "UserProfile", a ]);
}(), function() {
    "use strict";
        ...
        return a(b.v3baseUrl + "profile/", {}, {
            profile: {
                ...
                transformResponse: function(a, b) {
                    ...
                    return c.payload.data.is_authenticated = c.success, c.payload.data;
                }
            }
        });
    };
...
function() {
	...
	*/
    ...
    var a = function(a, b, c, d, e, f, g) {
		...
		*/
        this.orders = e.data, this.orderFrom = 50 * (this.params.page - 1) + 1, this.orderTo = this.orderFrom - 1 + e.data.length, 
        this.total_pages = e.total_pages, this.total_orders = e.total_orders, this.pending_orders_count = e.pending_orders_count, 
        this.unassigned_orders_count = e.unassigned_orders_count, /*
		...
		*/
        this.status_list = f.status, this.time_list = f.time, /*
		...
		*/
        this.paginate = {
            nextpage: function() {
                h.params.page = h.params.page + 1, h.getOrders();
            },
		...
		*/
        this.dgSearchTextChange = function(a) {
            ...
            return d.dgPageQuery.query(b).$promise.then(function(a) {
                return a.data;
            });
        }, this.selectedDgChange = function(a) {
            a ? h.params.dg = a.phone_number : h.params.dg = void 0, h.getOrders();
        }, /*
			@getOrders rleoads the order controller according too the filter to get the new filtered data.
		*/
        this.handleOrdeSelection = {
            selectActive: g.isSelected(),
            numberOfSelectedOrder: g.slectedItemLength(),
            update: function() {
                h.handleOrdeSelection.selectActive = g.isSelected(), h.handleOrdeSelection.numberOfSelectedOrder = g.slectedItemLength();
            },
            toggle: function(a) {
                g.toggle(a), h.handleOrdeSelection.update();
            },
            exists: function(a) {
                return g.exists(a);
            },
            clear: function() {
                g.clearAll(), h.handleOrdeSelection.update();
            }
        }, /*
			@getOrders rleoads the order controller according too the filter to get the new filtered data.
		*/
    ...
    } ]).controller("opsOrderCntrl", [ "$state", "$mdSidenav", "$stateParams", "DeliveryGuy", "orders", "constants", "orderSelection", a ]).controller("vendorOrderCntrl", [ "$state", b ]);
}(), function() {
    "use strict";
    var a = function() {
        return a;
	...
	*/
    ...
    function b(a, b, c) {
        var d = this;
        d.selectedTeamMembers = [], d.cancel = function() {
            a.cancel();
        }, d.addTeamDg = function(a) {
            console.log(a), console.log(d.selectedTeamMembers);
    ...
    var c = function(c, d, e, f, g, h, i, j) {
        var k = this;
        k.DG = i.payload.data.data, k.attendance_date = moment().date(1).toDate(), k.attendanceMinDate = moment("2015-01-01").toDate(), 
        k.attendanceMaxDate = moment().toDate(), k.OpsManagers = h.OpsManager.payload.data, 
        k.TeamLeads = h.TeamLead.payload.data, k.showEditDialog = function() {
            var b = e("sm") || e("xs");
            d.show({
                ...
                locals: {
                    DG: k.DG,
                    OpsManagers: k.OpsManagers,
                    TeamLeads: k.TeamLeads
                }
            }).then(function(a) {
                f.dg.$update(a, function(a) {
                    console.log(a);
                });
            }, function() {
                k.status = "You cancelled the dialog.";
            });
        }, /*
			function to redirect back to the previous page or parent page.
		*/
        k.goBack = function() {
            j.isAvailable() ? j.redirectToPrevious() : c.go("home.dgList");
        }, k.onlyMonthsPredicate = function(a) {
            var b = moment(a).date();
            return 1 === b;
        }, k.getTeamMembers = function() {
            f.dg.associated_dgs({
                id: k.DG.id
            }, function(a) {
                k.associated_dg_list = a.payload.data;
            });
        }, k.toTeamlead = function() {
            var a = e("sm") || e("xs");
            d.show({
        ...
        }, k.getAttendance = function() {
            var a = {
                id: k.DG.id,
                month: moment(k.attendance_date).month() + 1,
                year: moment(k.attendance_date).year()
            };
            f.dg.attendance(a, function(a) {
                k.dg_monthly_attendance = a.payload.data.dg_monthly_attendance[0].attendance;
            });
        };
    };
    angular.module("deliveryguy").controller("dgDetailCntrl", [ "$state", "$mdDialog", "$mdMedia", "DeliveryGuy", "dgConstants", "leadUserList", "DG", "PreviousState", c ]);
}();
