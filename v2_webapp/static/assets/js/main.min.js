/*! Vendor-Webaap - v0.0.0 - 2016-03-18 */
!function() {
    "use strict";
        ...
        this.loader = !1, this.userLogin = function() {
            ...
            b.login(g).then(function(b) {
                d.token = b.data.payload.data.auth_token, c.$refresh().then(function(b) {
                    b.role === e.userRole.OPS_MANAGER || b.role === e.userRole.OPS ? a.go("home.opsorder") : b.role === e.userRole.VENDOR ? a.go("home.order") : b.role === e.userRole.HR ? a.go("home.dgList") : b.role === e.userRole.ACCOUNTS && a.go("home.opsorder");
                });
            }, function(a) {
    ...
    "use strict";
    angular.module("ygVendorApp", [ "ngMaterial", "ngMessages", "ui.router", "ngStorage", "ngResource", "base64", "login", "home", "order", "deliveryguy", "vendor", "reports", "Cod", "feedback", "forbidden" ]).config([ "$urlRouterProvider", "$locationProvider", "$resourceProvider", "$mdThemingProvider", "roleProvider", function(a, b, c, d, e) {
    ...
    var a = function(a, b, c, d, e, f) {
        var g = this;
        g.params = b, g.searchVendor = g.params.vendor_id, this.searchVendorActive = void 0 !== this.params.vendor_id, 
        g.report_stats = e.payload.data, g.params.start_date = moment(g.params.start_date).toDate(), 
        g.params.end_date = moment(g.params.end_date).toDate(), g.maxStartDate = moment().toDate(), 
        g.maxEndDate = moment(g.params.start_date).add(3, "months").toDate(), this.backFromSearch = function() {
            g.params.vendor_id = void 0, g.searchVendorActive = !1, g.getReports();
            ...
            a ? g.params.vendor_id = a.id : g.params.vendor_id = void 0, g.getReports();
            ...
            moment(g.params.end_date).diff(g.params.start_date, "months") > 3 && (g.params.end_date = moment(g.params.start_date).add(3, "months")), 
            ...
            f.loaderStart(), a.transitionTo(a.current, g.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
        ...
        a.state("home.reports", {
            ...
            resolve: {
                ...
                report: [ "Reports", "$stateParams", function(a, b) {
                    return b.start_date = void 0 !== b.start_date ? moment(new Date(b.start_date)).toISOString() : moment().set("date", 1).toISOString(), 
                    b.end_date = void 0 !== b.end_date ? moment(new Date(b.end_date)).toISOString() : moment().toISOString(), 
    ...
    } ]).controller("codCntrl", [ "$state", "$stateParams", a ]);
}(), function() {
    "use strict";
    function a(a, b) {
        var c = this;
    ...
    function b(a, b) {
        ...
        c.deposit = b, c.cancel = function() {
            ...
            b.is_accepted = !1, b.transaction_id = c.deposit.transaction_id, a.hide(b);
        };
    }
    var c = function(c, d, e, f, g, h) {
        var i = this;
        i.params = d, i.deposits = f.payload.data.all_transactions, i.total_pages = f.payload.data.total_pages, 
        i.total_deposits = f.payload.data.total_bank_deposit_count, i.showImage = function(a) {
            a = a.replace(/:/g, "%3A");
            ...
            e.show({
                ...
                h.loaderStart(), g.verifyDeposits.update(a, function(a) {
                    h.showSuccess("Proof Download Successful"), h.loaderComplete(), i.getDeposits();
                });
            });
            ...
            e.show({
                ...
                h.loaderStart(), g.verifyDeposits.update(a, function(a) {
                    h.loaderComplete(), h.showSuccess("Proof Download Successful"), i.getDeposits();
                });
            });
        ...
        a.state("home.cod.deposit", {
            ...
            resolve: {
                ...
                deposits: [ "COD", "$stateParams", function(a, b) {
                    return b.page = isNaN(b.page) ? 1 : parseInt(b.page), a.getDeposits.get(b).$promise;
                } ]
            }
        });
    ...
    } ]).controller("codTransferCntrl", [ "$state", "$stateParams", a ]);
}(), function() {
    "use strict";
    var a = function(a, b) {
        console.log("history");
    ...
    } ]).controller("codHistoryCntrl", [ "$state", "$stateParams", a ]);
}(), function() {
    "use strict";
    ...
    var a = function(a, b, c, d, e, f, g) {
        console.log(d);
        var h = this;
        this.params = b, this.ticket = d.payload.data.helpdesk_ticket, this.groups = e.payload.data, 
        h.goBack = function() {
            g.isAvailable() ? g.redirectToPrevious() : a.go("home.feedbackList");
        }, this.getGroupName = function(a) {
            if (h.groups) for (var b = 0; b < h.groups.length; b++) if (a == h.groups[b].group.id) return h.groups[b].group.name;
    ...
    angular.module("feedback").controller("feedbackDetailCntrl", [ "$state", "$stateParams", "Feedback", "ticket", "groups", "Notification", "PreviousState", a ]);
}();
