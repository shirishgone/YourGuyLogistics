/*! Vendor-Webaap - v0.0.0 - 2016-04-05 */
!function() {
    "use strict";
        ...
        a.state("home.reports", {
            ...
            resolve: {
                ...
                report: [ "Reports", "$stateParams", function(a, b) {
                    var c = new Date();
                    return c.setHours(0), c.setMinutes(0), c.setSeconds(0), c.setDate(1), b.start_date = void 0 !== b.start_date ? new Date(b.start_date).toISOString() : c.toISOString(), 
