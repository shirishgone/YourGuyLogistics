...
!function() {
    ...
    var b = function(b, c, d, e, f, g, h) {
        ...
        this.paginate = {
            ...
            clearAll: function() {
                return i.handleSelection.selectedItemArray = [], i.handleSelection.selectedItemArray;
            },
            slectedItemLength: function() {
            ...
            d.show({
                ...
                a.delivery_ids = i.handleSelection.getAlltransactionIds(), g.loaderStart(), f.tranferToClient.send(a, function(a) {
    ...
    var a = function(a, b, c, d, e) {
        ...
        f.total_deposits = c.payload.data.total_bank_deposit_count, this.searchVendor = this.params.vendor_id, 
