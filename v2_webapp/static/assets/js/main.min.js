...
!function() {
    ...
    var c = function(c, d, e, f, g, h, i) {
        var j = this;
        j.params = d, j.deposits = f.payload.data.all_transactions, j.total_pages = f.payload.data.total_pages, 
        j.total_deposits = f.payload.data.total_count, this.searchVendor = this.params.dg_name, 
        ...
        j.showImage = function(a) {
            a = a.replace(/:/g, "%3A");
            var b = "https://s3-ap-southeast-1.amazonaws.com/bank-deposit-test/" + a;
            j.showImageSection = !0, j.depositImage = b;
        }, j.verifyDeposit = function(b) {
            e.show({
                ...
                h.loaderStart(), g.verifyDeposits.update(a, function(a) {
                    h.showSuccess("Deposit Verified Successfully"), h.loaderComplete(), j.getDeposits();
                });
            });
        }, j.declineDeposit = function(a) {
            e.show({
                ...
                h.loaderStart(), g.verifyDeposits.update(a, function(a) {
                    h.loaderComplete(), h.showSuccess("Deposit Declined Successfully"), j.getDeposits();
                });
            });
        }, this.paginate = {
            nextpage: function() {
                j.params.page = j.params.page + 1, j.getDgs();
            },
            previouspage: function() {
                j.params.page = j.params.page - 1, j.getDgs();
            }
            ...
            a ? (j.params.dg_id = a.id, j.params.dg_name = a.name) : (j.params.dg_id = void 0, 
            j.params.dg_name = void 0);
        }, this.revertToPageOne = function() {
            j.params.page = 1, j.getDeposits();
        }, j.resetParams = function() {
            j.params = {}, j.getDeposits();
        }, this.getDeposits = function() {
            j.params.dg_id || (j.params.dg_name = void 0), c.transitionTo(c.current, j.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
    ...
    } ]).controller("codDepositCntrl", [ "$state", "$stateParams", "$mdDialog", "deposits", "COD", "Notification", "DeliveryGuy", c ]);
}(), function() {
    "use strict";
    function a(a, b) {
        var c = this;
