...
function() {
	...
	*/
    ...
    var b = function(b, c, d, e, f, g, h, i) {
        var j = this;
        j.DG = h.payload.data.data, j.attendance_date = moment().date(1).toDate(), j.attendanceMinDate = moment("2015-01-01").toDate(), 
        j.attendanceMaxDate = moment().toDate(), j.OpsManagers = g.OpsManager.payload.data, 
        j.TeamLeads = g.TeamLead.payload.data, j.showEditDialog = function() {
            var b = d("sm") || d("xs");
            c.show({
		...
		*/
        j.goBack = function() {
            ...
            var a = {
                id: j.DG.id,
                month: moment(j.attendance_date).month() + 1,
                year: moment(j.attendance_date).year()
            };
            e.dg.attendance(a, function(a) {
                j.dg_monthly_attendance = a.payload.data.dg_monthly_attendance[0].attendance;
            });
        };
    };
