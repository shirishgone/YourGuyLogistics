/*! Vendor-Webaap - v0.0.0 - 2016-03-02 */
!function() {
    "use strict";
...
function() {
	...
	*/
    ...
    var c = function(c, d, e, f, g, h, i, j, k) {
        var l = this;
        l.params = d, l.DG = j.payload.data.data, l.attendance_date = moment().date(1).toDate(), 
		...
		*/
        l.goBack = function() {
            ...
            g.dg.attendance(a, function(a) {
                l.dg_monthly_attendance = a.payload.data.dg_monthly_attendance[0].attendance;
            });
    ...
    angular.module("vendor", []).config([ "$stateProvider", function(a) {
        a.state("home.vendorList", {
            ...
            resolve: {
                access: [ "Access", "constants", function(a, b) {
                    var c = [ b.userRole.OPS, b.userRole.OPS_MANAGER, b.userRole.SALES, b.userRole.SALES_MANAGER, b.userRole.ACCOUNTS ];
                    return a.hasAnyRole(c);
                } ],
    ...
    var a = function(a, b, c, d) {
        var e = this;
        e.params = c, this.searchVendorActive = void 0 !== this.params.search ? !0 : !1, 
        /*
