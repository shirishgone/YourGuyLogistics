/*! Vendor-Webaap - v0.0.0 - 2016-04-15 */
!function() {
    "use strict";
    ...
    var a = {
        ...
        assignment: "Pickup Unassigned",
        value: "UNASSIGNED_PICKUP"
    }, {
        assignment: "Delivery Unassigned",
        value: "UNASSIGNED_DELIVERY"
    }, {
        assignment: "Both Unassigned",
        value: "UNASSIGNED"
    } ], f = {
        v1baseUrl: "/api/v1/",
        v2baseUrl: "/api/v2/",
    ...
    angular.module("ygVendorApp").constant("constants", f);
}(), function() {
    "use strict";
    var a = function(a, b) {
        var c = {
    ...
    var a = function(a, b) {
        return {
            dg: a(b.v3baseUrl + "deliveryguy/:id/", {
                ...
                associateVendors: {
                    url: b.v3baseUrl + "deliveryguy/:id/add_vendor/",
                    method: "PUT"
                },
                demoteTL: {
                    url: b.v3baseUrl + "deliveryguy/:id/demote_teamlead/",
                    method: "PUT"
                }
            }),
        ...
        a.state("home.opsorder", {
            ...
            resolve: {
                ...
                orders: [ "Order", "$stateParams", function(a, b) {
                    ...
                    b.is_retail = "true" == b.is_retail ? Boolean(b.is_retail) : void 0, b.is_pop = "true" == b.is_pop ? Boolean(b.is_pop) : void 0, 
                    b.is_pod = "true" == b.is_pod ? Boolean(b.is_pod) : void 0, Array.isArray(b.order_status) && (b.order_status = b.order_status.length > 0 ? b.order_status.toString() : void 0), 
    ...
    var b = function(b, c, d, e) {
        return {
            openStatusDialog: function(f) {
                var g = e.defer(), h = {
                    pickup: !0,
                    delivery: !0
                };
                if (f) {
                    if (!f.pickupguy_id) return d.showError("Please assign Pickup guy for the order"), 
                    g.reject("no pickup guy"), g.promise;
                    if (f.pickupguy_id && !f.deliveryguy_id) h.delivery = !1; else if (!f.pickupguy_id && !f.deliveryguy_id) return d.showError("Please assign DG for the order"), 
                    g.reject("no dg guy"), g.promise;
                }
                var i = b("sm") || b("xs");
                return c.show({
                    controller: [ "$mdDialog", "status", a ],
    ...
    angular.module("order").factory("OrderStatusUpdate", [ "$mdMedia", "$mdDialog", "Notification", "$q", b ]);
}(), function() {
    "use strict";
    var a = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
        var q = function() {
            return 0 !== r.params.order_status.length || void 0 !== r.params.vendor_id || void 0 !== r.params.dg_username || void 0 !== r.params.search || void 0 !== r.params.end_time || void 0 !== r.params.start_time || r.params.is_retail !== !1 || r.params.is_cod !== !1 || void 0 !== r.params.pincodes;
        }, r = this;
        ...
        this.pincodes = l.payload.data, 0 === r.orders.length && q() ? r.noContent = !0 : 0 !== r.orders.length || q() ? r.noContent = !1 : r.noContent = !0, 
        this.status_list = j.status, this.time_list = j.time, this.dg_assignment = j.dg_assignment, 
        this.revertToPageOne = function() {
            r.params.page = 1, r.getOrders();
        }, this.resetParams = function() {
            r.params = {}, r.getOrders();
        }, this.backFromSearch = function() {
            r.params.search = void 0, r.searchOrderActive = !1, r.getOrders();
            ...
            nextpage: function() {
                r.params.page = r.params.page + 1, r.getOrders();
            },
            ...
            a ? (r.params.dg_username = a.phone_number, r.params.dg_name = a.name) : (r.params.dg_username = void 0, 
            r.params.dg_name = void 0);
            ...
            a ? (r.params.vendor_id = a.id, r.params.vendor_name = a.name) : (r.params.vendor_id = void 0, 
            r.params.vendor_name = void 0);
        }, this.handleOrdeSelection = {
            selectActive: k.isSelected(),
            numberOfSelectedOrder: k.slectedItemLength(),
            update: function() {
                r.handleOrdeSelection.selectActive = k.isSelected(), r.handleOrdeSelection.numberOfSelectedOrder = k.slectedItemLength();
            },
            toggle: function(a) {
                k.toggle(a), r.handleOrdeSelection.update();
            },
            exists: function(a) {
                return k.exists(a);
            },
            clear: function() {
                k.clearAll(), r.handleOrdeSelection.update();
            }
        }, r.assignDg = function() {
            ...
            m.all(b).then(function(a) {
                k.clearAll(), r.getOrders();
            });
        }, this.statusUpdateForSingleDialog = function(a) {
            o.openStatusDialog(a).then(function(b) {
            ...
            for (var a = 0; a < k.selectedItemArray.length; a++) if (!k.selectedItemArray[a].deliveryguy_id || !k.selectedItemArray[a].pickupguy_id) return p.showError("Please assign DG for each order");
            o.openStatusDialog().then(function(a) {
                a.delivery_ids = k.getAllItemsIds(), "pickup" == a.status ? r.updatePickupStatus(a) : "delivered" == a.status ? r.updateDeliveryStatus(a) : "pickup_attempted" == a.status ? r.updatePickupAttemtedStatus(a) : "delivery_attempted" == a.status && r.updateDeliveryAtemptedStatus(a);
            });
            ...
            k.isSelected() ? r.handleOrdeSelection.toggle(b) : a.go("home.orderDetail", {
                id: b.id
            });
        }, this.getOrders = function() {
            r.params.vendor_id || (r.params.vendor_name = void 0), r.params.dg_username && "UNASSIGNED_PICKUP" != r.params.dg_username && "UNASSIGNED_DELIVERY" != r.params.dg_username && "UNASSIGNED" != r.params.dg_username || (r.params.dg_name = void 0), 
    ...
    angular.module("order").controller("opsOrderCntrl", [ "$state", "$mdSidenav", "$mdDialog", "$mdMedia", "$stateParams", "DeliveryGuy", "Order", "Vendor", "orders", "constants", "orderSelection", "Pincodes", "$q", "orderDgAssign", "OrderStatusUpdate", "Notification", a ]);
}(), function() {
    "use strict";
    var a = function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
        ...
        if (r.params = b, r.order = d.payload.data, r.order.delivery_transactions.length > 0) for (var s = 0; s < r.order.delivery_transactions.length; s++) "OutForDelivery" == r.order.delivery_transactions[s].delivery_transaction_title && (r.order.out_for_delivery_time = r.order.delivery_transactions[s].delivery_transaction_timestamp), 
        "COD Update" == r.order.delivery_transactions[s].delivery_transaction_title && (r.order.cod_update_reason = r.order.delivery_transactions[s].delivery_transaction_timestamp);
        var t = function() {
        ...
        r.goBack = function() {
            ...
            h.openStatusDialog(a).then(function(b) {
                b.delivery_ids = [ a.id ], "pickup" == b.status ? r.updatePickupStatus(b) : "delivered" == b.status ? r.updateDeliveryStatus(b) : "pickup_attempted" == b.status ? r.updatePickupAttemtedStatus(b) : "delivery_attempted" == b.status && r.updateDeliveryAtemptedStatus(b);
            });
        ...
        a.state("home.dgList", {
            ...
            resolve: {
                ...
                dgs: [ "DeliveryGuy", "$stateParams", function(a, b) {
                    ...
                    d.endOf("day")), b.is_teamlead = "true" == b.is_teamlead ? Boolean(b.is_teamlead) : void 0, 
                    b.start_date = void 0 !== b.start_date ? b.start_date.toISOString() : c.toISOString(), 
            ...
            resolve: {
                ...
                leadUserList: [ "DeliveryGuy", "$q", function(a, b) {
                    return b.all({
                        ...
                        Pincodes: a.dgServicablePincodes.query().$promise
                    });
                } ]
            }
        }).state("home.dgDetail", {
    ...
    var a = function(a, b, c, d, e, f, g) {
        ...
        this.dgs = d.payload.data.data, this.total_pages = d.payload.data.total_pages, this.total_dgs = d.payload.data.total_count, 
        this.toggleFilter = function() {
            ...
            console.log("call"), a.transitionTo(a.current, h.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
    ...
    var a = function(a, b, c, d, e, f, g) {
        var h = this;
        h.shift_timings = c.shift_timings, h.transportation_mode = c.transportation_mode, 
        h.OpsManagers = e.OpsManager.payload.data, h.TeamLeads = e.TeamLead.payload.data, 
        h.Pincodes = e.Pincodes.payload.data, h.dg = new d.dg(), h.goBack = function() {
            f.isAvailable() ? f.redirectToPrevious() : a.go("home.dgList");
        }, h.create = function() {
            g.loaderStart(), h.dg.shift_timing = angular.fromJson(h.dg.shift_timing), h.dg.$save(function(a) {
                h.goBack();
            });
        };
    };
    angular.module("deliveryguy").controller("dgCreateCntrl", [ "$state", "$mdSidenav", "dgConstants", "DeliveryGuy", "leadUserList", "PreviousState", "Notification", a ]);
}(), function() {
    "use strict";
    function a(a, b, c, d, e, f) {
        var g = this;
        g.DG = angular.copy(c), g.DG.team_lead_dg_ids = [], g.DG.ops_manager_ids = [], g.DG.team_leads.forEach(function(a) {
            a.dg_id && g.DG.team_lead_dg_ids.push(a.dg_id);
        }), g.DG.ops_managers.forEach(function(a) {
            g.DG.ops_manager_ids.push(a.employee_id);
        }), g.OpsManagers = d, g.TeamLeads = e, g.shift_timings = b.shift_timings, g.transportation_mode = b.transportation_mode, 
        f.dgServicablePincodes.query().$promise.then(function(a) {
            g.Pincodes = a.payload.data;
        }), g.findShiftTime = function(a) {
            return g.shift_timings.findIndex(function(b) {
                return b.start_time == a.start_time;
            });
        }, g.DG.shift_time = g.shift_timings[g.findShiftTime(g.DG.shift_time)], g.cancel = function() {
            a.cancel();
        }, g.answer = function(b) {
            a.hide(b);
        };
    ...
    function b(a, b, c, d) {
        var e = this;
        e.DG = angular.copy(b), e.selectedTeamMembers = [], e.teamLeadData = {
            id: b.id,
            pincodes: e.DG.pincodes,
            associate_dgs: []
        }, d && d.forEach(function(a) {
            e.selectedTeamMembers.push({
                name: a.dg_name,
                phone_number: a.dg_phonenumber,
                id: a.dg_id
            });
        }), e.cancel = function() {
            a.cancel();
        }, c.dgServicablePincodes.query().$promise.then(function(a) {
            e.pincodes = a.payload.data;
        }), e.dgSearch = function(a) {
            var b = {
                search: a
            };
        ...
        }, e.transformChip = function(a) {
            return angular.isObject(a) ? {
                name: a.name,
                phone_number: a.phone_number,
                id: a.id
            } : void 0;
        }, e.transformPinChip = function(a) {
            return angular.isObject(a) ? a.pincode : void 0;
        }, e.submitTlData = function() {
            e.selectedTeamMembers.forEach(function(a) {
                e.teamLeadData.associate_dgs.push(a.id);
            }), a.hide(e.teamLeadData);
        };
    }
    function c(a, b) {
        var c = this;
    ...
    function d(a, b, c) {
        var d = this;
        d.DG = angular.copy(b), d.selectedVendors = d.DG.associated_vendors, d.vendorSearch = function(a) {
            var b = {
                search: a
            };
            return c.query(b).$promise.then(function(a) {
                return a.payload.data.data;
            });
        }, d.transformVendorChip = function(a) {
            ...
            b.forEach(function(a) {
                c.vendor_ids.push(a.id);
            }), c.id = d.DG.id, a.hide(c);
        };
    }
    function e(a, b) {
        var c = this;
    ...
    var f = function(f, g, h, i, j, k, l, m, n, o, p) {
        var q = this;
        q.params = g, q.DG = n.payload.data, q.attendance_date = moment().date(1).toDate(), 
        q.attendanceMinDate = moment("2015-01-01").toDate(), q.attendanceMaxDate = moment().toDate(), 
        q.OpsManagers = m.OpsManager.payload.data, q.TeamLeads = m.TeamLead.payload.data, 
        q.showEditDialog = function() {
            var b = i("sm") || i("xs");
            h.show({
                controller: [ "$mdDialog", "dgConstants", "DG", "OpsManagers", "TeamLeads", "DeliveryGuy", a ],
                controllerAs: "dgEdit",
                ...
                locals: {
                    DG: q.DG,
                    OpsManagers: q.OpsManagers,
                    TeamLeads: q.TeamLeads
                }
            }).then(function(a) {
                p.loaderStart(), a.shift_time = angular.fromJson(a.shift_time), j.dg.$update(a, function(a) {
                    q.getDgDetails(), p.loaderComplete();
                });
            }, function() {
                q.status = "You cancelled the dialog.";
            });
        }, q.goBack = function() {
            o.isAvailable() ? o.redirectToPrevious() : f.go("home.dgList");
        }, q.deactivateDgDialog = function() {
            var a = i("sm") || i("xs");
            h.show({
                ...
                p.loaderStart(), j.dg.deactivate(a, function(a) {
                    p.loaderComplete(), p.showSuccess("DG deactivated successfully"), q.getDgDetails();
                });
            });
        }, q.onlyMonthsPredicate = function(a) {
            var b = moment(a).date();
            return 1 === b;
        }, q.getTeamMembers = function() {
            j.dg.associated_dgs({
                id: q.DG.id
            }, function(a) {
                q.associated_dg_list = a.payload.data;
            });
        }, q.DG.is_teamlead && q.getTeamMembers(), q.toTeamlead = function() {
            h.show({
                controller: [ "$mdDialog", "DG", "DeliveryGuy", "teamMembers", b ],
                ...
                locals: {
                    DG: q.DG,
                    teamMembers: q.associated_dg_list
                }
            }).then(function(a) {
                p.loaderStart(), q.DG.is_teamlead ? j.dg.$update(a, function(a) {
                    p.loaderComplete(), q.getDgDetails();
                }) : j.dg.promoteToTL(a, function(a) {
                    p.loaderComplete(), q.getDgDetails();
                });
            }, function() {
                q.status = "You cancelled the dialog.";
            });
        }, q.demoteTeamlead = function(a) {
            console.log("demote");
            var b = i("sm") || i("xs");
            h.show({
                controller: [ "$mdDialog", "DG", e ],
                ...
                p.loaderStart(), j.dg.demoteTL(a, function(a) {
                    p.loaderComplete(), p.showSuccess("Team Lead was demoted successfully"), q.getDgDetails();
                });
            });
        }, q.associateVendors = function() {
            h.show({
                controller: [ "$mdDialog", "DG", "Vendor", d ],
                ...
                p.loaderStart(), j.dg.associateVendors(a, function(a) {
                    p.loaderComplete(), q.getDgDetails();
                });
            });
        }, q.getAttendance = function() {
            var a = {
                id: q.DG.id,
                month: moment(q.attendance_date).month() + 1,
                year: moment(q.attendance_date).year()
            };
            j.dg.attendance(a, function(a) {
                q.dg_monthly_attendance = a.payload.data.attendance;
            });
        }, q.toggleTeamLead = function(a) {
            a.is_teamlead ? q.demoteTeamlead(a) : q.toTeamlead();
        }, q.getDgDetails = function() {
            f.transitionTo(f.current, q.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
    ...
    angular.module("deliveryguy").controller("dgDetailCntrl", [ "$state", "$stateParams", "$mdDialog", "$mdMedia", "DeliveryGuy", "Vendor", "dgConstants", "leadUserList", "DG", "PreviousState", "Notification", f ]);
}(), function() {
    "use strict";
    ...
    angular.module("reports", [ "ng-fusioncharts" ]).config([ "$stateProvider", function(a) {
        a.state("home.reports", {
            ...
            resolve: {
                access: [ "Access", "constants", function(a, b) {
                    var c = [ b.userRole.OPS, b.userRole.OPS_MANAGER, b.userRole.SALES, b.userRole.SALES_MANAGER, b.userRole.VENDOR, b.userRole.ACCOUNTS ];
                    return a.hasAnyRole(c);
                } ],
                report: [ "Reports", "$stateParams", function(a, b) {
                    var c, d;
                    return b.start_date ? (b.start_date = moment(new Date(b.start_date)), b.start_date.startOf("day")) : (c = moment(), 
                    c.startOf("month")), b.end_date ? (b.end_date = moment(new Date(b.end_date)), b.end_date.endOf("day")) : (d = moment(), 
    ...
    var c = function(c, d, e, f, g, h, i, j) {
        var k = this;
        k.params = d, k.deposits = f.payload.data.all_transactions, k.total_pages = f.payload.data.total_pages, 
        k.total_deposits = f.payload.data.total_count, this.selectedDg = this.params.dg_name, 
        ...
        k.showImage = function(a) {
            a = a.replace(/:/g, "%3A");
            var b = "https://s3-ap-southeast-1.amazonaws.com/" + j.DEPOSIT_BUCKET + "/" + a;
            k.showImageSection = !0, k.depositImage = b;
        }, k.verifyDeposit = function(b) {
            e.show({
                ...
                h.loaderStart(), g.verifyDeposits.update(a, function(a) {
                    h.showSuccess("Deposit Verified Successfully"), h.loaderComplete(), k.getDeposits();
                });
            });
        }, k.declineDeposit = function(a) {
            e.show({
                ...
                h.loaderStart(), g.verifyDeposits.update(a, function(a) {
                    h.loaderComplete(), h.showSuccess("Deposit Declined Successfully"), k.getDeposits();
                });
            });
        }, this.paginate = {
            nextpage: function() {
                k.params.page = k.params.page + 1, k.getDgs();
            },
            previouspage: function() {
                k.params.page = k.params.page - 1, k.getDgs();
            }
            ...
            return i.dgPageQuery.query(b).$promise.then(function(a) {
                return a.payload.data.data;
            });
        }, this.selectedDgChange = function(a) {
            a ? (k.params.dg_id = a.id, k.params.dg_name = a.name) : (k.params.dg_id = void 0, 
            k.params.dg_name = void 0);
        }, this.revertToPageOne = function() {
            k.params.page = 1, k.getDeposits();
        }, k.resetParams = function() {
            k.params = {}, k.getDeposits();
        }, this.getDeposits = function() {
            k.params.dg_id || (k.params.dg_name = void 0), c.transitionTo(c.current, k.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
    ...
    } ]).controller("codDepositCntrl", [ "$state", "$stateParams", "$mdDialog", "deposits", "COD", "Notification", "DeliveryGuy", "constants", c ]);
}(), function() {
    "use strict";
    function a(a, b) {
        var c = this;
