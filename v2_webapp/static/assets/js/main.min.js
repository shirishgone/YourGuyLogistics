/*! Vendor-Webaap - v0.0.0 - 2016-03-28 */
!function() {
    "use strict";
    ...
    var c = function(c, d, e, f, g, h, i, j, k, l) {
        var m = this;
        m.params = d, m.DG = j.payload.data, m.attendance_date = moment().date(1).toDate(), 
        m.attendanceMinDate = moment("2015-01-01").toDate(), m.attendanceMaxDate = moment().toDate(), 
        m.OpsManagers = i.OpsManager.payload.data, m.TeamLeads = i.TeamLead.payload.data, 
        m.showEditDialog = function() {
            var b = f("sm") || f("xs");
            e.show({
                ...
                locals: {
                    DG: m.DG,
                    OpsManagers: m.OpsManagers,
                    TeamLeads: m.TeamLeads
                }
            }).then(function(a) {
                l.loaderStart(), a.shift_time = angular.fromJson(a.shift_time), g.dg.$update(a, function(a) {
                    m.getDgDetails(), l.loaderComplete();
                });
            }, function() {
                m.status = "You cancelled the dialog.";
            });
        }, m.goBack = function() {
            k.isAvailable() ? k.redirectToPrevious() : c.go("home.dgList");
        }, m.onlyMonthsPredicate = function(a) {
            var b = moment(a).date();
            return 1 === b;
        }, m.getTeamMembers = function() {
            g.dg.associated_dgs({
                id: m.DG.id
            }, function(a) {
                m.associated_dg_list = a.payload.data;
            });
        }, m.toTeamlead = function() {
            e.show({
                ...
                l.loaderStart(), m.DG.is_teamlead ? g.dg.$update(a, function(a) {
                    l.loaderComplete(), m.getDgDetails();
        ...
        }, m.getAttendance = function() {
            var a = {
                id: m.DG.id,
                month: moment(m.attendance_date).month() + 1,
                year: moment(m.attendance_date).year()
            };
            g.dg.attendance(a, function(a) {
                m.dg_monthly_attendance = a.payload.data.attendance;
            });
        }, m.getDgDetails = function() {
            c.transitionTo(c.current, m.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
    ...
    angular.module("deliveryguy").controller("dgDetailCntrl", [ "$state", "$stateParams", "$mdDialog", "$mdMedia", "DeliveryGuy", "dgConstants", "leadUserList", "DG", "PreviousState", "Notification", c ]);
}(), function() {
    "use strict";
    ...
    var c = function(c, d, e, f, g, h) {
        ...
        i.total_deposits = f.payload.data.total_bank_deposit_count, this.searchVendor = this.params.vendor_id, 
    ...
    var b = function(b, c, d, e, f, g, h) {
        ...
        i.total_deposits = e.payload.data.total_bank_deposit_count, this.searchVendor = this.params.vendor_id, 
        console.log(e), this.params.start_date && (this.params.start_date = new Date(this.params.start_date)), 
        this.params.end_date && (this.params.end_date = new Date(this.params.end_date)), 
        this.paginate = {
            nextpage: function() {
                i.params.page = i.params.page + 1, i.getDgs();
            ...
            toggle: function(a) {
                if (console.log(i.handleSelection.selectedItemArray.length), i.handleSelection.selectedItemArray.length > 0) {
                    if (a.vendor_id != i.handleSelection.selectedVendor) return void alert("You cannot select different vendor");
                } else console.log("sds"), i.handleSelection.selectedVendor = a.vendor_id;
            ...
            b.transitionTo(b.current, i.params, {
                reload: !0,
                inherit: !1,
                notify: !0
            });
    ...
    var a = function(a, b, c, d, e) {
        ...
        f.total_deposits = c.payload.data.total_count, this.searchVendor = this.params.vendor_id, 
        console.log(c), this.params.start_date && (this.params.start_date = new Date(this.params.start_date)), 
        this.params.end_date && (this.params.end_date = new Date(this.params.end_date)), 
        this.paginate = {
            nextpage: function() {
            ...
            a ? f.params.vendor_id = a.id : f.params.vendor_id = void 0;
